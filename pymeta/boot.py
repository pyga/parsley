...
class BootOMetaGrammar(OMetaBase):
    ...
    def rule_number(self):
        ...
        _G_apply_1, lastError = self._apply("spaces", )
        self.considerError(lastError)
        def _G_or_2():
            _G_exactly_1, lastError = self.exactly('-')
            self.considerError(lastError)
            _G_apply_2, lastError = self._apply("barenumber", )
            self.considerError(lastError)
        ...
        def _G_or_3():
            _G_apply_1, lastError = self._apply("barenumber", )
            self.considerError(lastError)
    ...
    def rule_barenumber(self):
        ...
        def _G_or_1():
            ...
            def _G_or_2():
                ...
                self.considerError(lastError)
                def _G_many_4():
                    _G_apply_1, lastError = self._apply("hexdigit", )
                    self.considerError(lastError)
            ...
            def _G_or_3():
                def _G_many_1():
                    _G_apply_1, lastError = self._apply("octaldigit", )
                    self.considerError(lastError)
                    return (_G_apply_1, self.currentError)
        ...
        def _G_or_2():
            def _G_many1_1():
                _G_apply_1, lastError = self._apply("digit", )
                self.considerError(lastError)
                return (_G_apply_1, self.currentError)
    ...
    def rule_octaldigit(self):
        ...
        _G_apply_1, lastError = self._apply("anything", )
        self.considerError(lastError)
        _locals['x'] = _G_apply_1
        def _G_pred_2():
    ...
    def rule_character(self):
        ...
        self.considerError(lastError)
        _G_apply_2, lastError = self._apply("token", _G_python_1)
        self.considerError(lastError)
        def _G_or_3():
            _G_apply_1, lastError = self._apply("escapedChar", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
        def _G_or_4():
            _G_apply_1, lastError = self._apply("anything", )
        ...
        self.considerError(lastError)
        _G_apply_7, lastError = self._apply("token", _G_python_6)
        self.considerError(lastError)
    ...
    def rule_string(self):
        ...
        def _G_many_3():
            ...
            def _G_or_2():
                ...
                self.considerError(lastError)
                _G_apply_3, lastError = self._apply("anything", )
                self.considerError(lastError)
        ...
        self.considerError(lastError)
        _G_apply_6, lastError = self._apply("token", _G_python_5)
        self.considerError(lastError)
    ...
    def rule_name(self):
        ...
        _G_apply_1, lastError = self._apply("letter", )
        self.considerError(lastError)
        _locals['x'] = _G_apply_1
        def _G_many_2():
            _G_apply_1, lastError = self._apply("letterOrDigit", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
    ...
    def rule_application(self):
        ...
        _G_apply_2, lastError = self._apply("token", _G_python_1)
        self.considerError(lastError)
        _G_apply_3, lastError = self._apply("spaces", )
        self.considerError(lastError)
        _G_apply_4, lastError = self._apply("name", )
        self.considerError(lastError)
    ...
    def rule_expr1(self):
        ...
        def _G_or_1():
            _G_apply_1, lastError = self._apply("application", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
        def _G_or_2():
            _G_apply_1, lastError = self._apply("ruleValue", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
        def _G_or_3():
            _G_apply_1, lastError = self._apply("semanticPredicate", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
        def _G_or_4():
            _G_apply_1, lastError = self._apply("semanticAction", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
        def _G_or_5():
            _G_apply_1, lastError = self._apply("number", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
        def _G_or_6():
            _G_apply_1, lastError = self._apply("character", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
        def _G_or_7():
            _G_apply_1, lastError = self._apply("string", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
        def _G_or_8():
            _G_python_1, lastError = eval("'('", self.globals, _locals), None
            ...
            _G_apply_2, lastError = self._apply("token", _G_python_1)
            self.considerError(lastError)
            _G_apply_3, lastError = self._apply("expr", )
            self.considerError(lastError)
            _locals['e'] = _G_apply_3
            _G_python_4, lastError = eval("')'", self.globals, _locals), None
            self.considerError(lastError)
            _G_apply_5, lastError = self._apply("token", _G_python_4)
            self.considerError(lastError)
    ...
    def rule_expr2(self):
        ...
        def _G_or_1():
            ...
            def _G_or_3():
                ...
                _G_apply_2, lastError = self._apply("token", _G_python_1)
                self.considerError(lastError)
                _G_apply_3, lastError = self._apply("expr2", )
                self.considerError(lastError)
                _locals['e'] = _G_apply_3
                ...
                return (_G_python_4, self.currentError)
            def _G_or_4():
                _G_apply_1, lastError = self._apply("expr2", )
                self.considerError(lastError)
        ...
        def _G_or_2():
            _G_apply_1, lastError = self._apply("expr1", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
        _G_or_3, lastError = self._or([_G_or_1, _G_or_2])
        self.considerError(lastError)
    ...
    def rule_expr3(self):
        ...
        def _G_or_1():
            ...
            def _G_or_7():
                _G_exactly_1, lastError = self.exactly(':')
                self.considerError(lastError)
                _G_apply_2, lastError = self._apply("name", )
                self.considerError(lastError)
        ...
        def _G_or_2():
            ...
            _G_apply_2, lastError = self._apply("token", _G_python_1)
            self.considerError(lastError)
            _G_apply_3, lastError = self._apply("name", )
            self.considerError(lastError)
    ...
    def rule_expr4(self):
        ...
        def _G_many_1():
            _G_apply_1, lastError = self._apply("expr3", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
        _G_many_2, lastError = self.many(_G_many_1)
        self.considerError(lastError)
    ...
    def rule_expr(self):
        ...
        _G_apply_1, lastError = self._apply("expr4", )
        self.considerError(lastError)
        _locals['e'] = _G_apply_1
        def _G_many_2():
            _G_python_1, lastError = eval("'|'", self.globals, _locals), None
            ...
            _G_apply_2, lastError = self._apply("token", _G_python_1)
            self.considerError(lastError)
            _G_apply_3, lastError = self._apply("expr4", )
            self.considerError(lastError)
            return (_G_apply_3, self.currentError)
        _G_many_3, lastError = self.many(_G_many_2)
        self.considerError(lastError)
    ...
    def rule_rulePart(self):
        ...
        _G_apply_2, lastError = self._apply("spaces", )
        self.considerError(lastError)
        _G_apply_3, lastError = self._apply("name", )
        self.considerError(lastError)
        _locals['n'] = _G_apply_3
        ...
        self.considerError(lastError)
        _G_apply_7, lastError = self._apply("expr4", )
        self.considerError(lastError)
    ...
    def rule_rule(self):
        ...
        self.considerError(lastError)
        def _G_lookahead_2():
            _G_apply_1, lastError = self._apply("name", )
            self.considerError(lastError)
        ...
        self.considerError(lastError)
        _G_apply_5, lastError = self._apply("rulePart", _G_python_4)
        self.considerError(lastError)
        ...
        def _G_or_6():
            def _G_many1_1():
                ...
                self.considerError(lastError)
                _G_apply_2, lastError = self._apply("rulePart", _G_python_1)
                self.considerError(lastError)
    ...
    def rule_grammar(self):
        ...
        def _G_many_1():
            _G_apply_1, lastError = self._apply("rule", )
            self.considerError(lastError)
            return (_G_apply_1, self.currentError)
        _G_many_2, lastError = self.many(_G_many_1)
        self.considerError(lastError)
